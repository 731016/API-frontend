...
const InterfaceInfo: React.FC = () => {
  ...
  const docUrl =
    process.env.NODE_ENV === 'production' ? 'https://github.com/731016/api-sdk' : 'https://github.com/731016/api-sdk';
  ...
  return (
    <Spin spinning={loading}>
      ...
      {activeTabKey === 'sampleCode' && requestExampleActiveTabKey === 'javadoc' && (
        ...
        >
          <Button size={'large'}>
            <a target={'_blank'} href={'https://github.com/731016/api-sdk'} rel="noreferrer">
